  ...
  <table id="tableQuarter" class="table table-bordered table-sm mb-0" border="1">
      <thead>
        <tr style="background: rgb(223, 223, 223);">
          ...
          <th>Rate</th>
          <th>SIR</th>
          <th class="dn" onload="">nLCL</th>
          <th>LCL</th>
          <th class="dn" onload="">nLWL</th>
          <th>LWL</th>
          <th class="dn" onload="">nUWL</th>
          <th>UWL</th>
          <th class="dn" onload="">nUCL</th>
          <th>UCL</th>
          <!-- <th>CL-LCL</th>
          <th>CL-LWL</th>
          <th>UWL-CL</th>
  ...
  if($period == 'Quarter'){
    for ($i=0; $i < $round ; $i++) {
      ...
      <tr>
        ...
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($buffer_1), 'r2')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($bb4 != 0){ $buffer_6 = $buffer_5/$bb4; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($buffer_1), 'r1')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($bb4 != 0){ $buffer_6 = $buffer_5/$bb4; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($buffer_1 + 1), 'r3')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($bb4 != 0){ $buffer_6 = $buffer_5/$bb4; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($buffer_1 + 1), 'r4')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($bb4 != 0){ $buffer_6 = $buffer_5/$bb4; }; echo number_format($buffer_6, 2);?></td>
        <!-- <td>1</td> -->
        <!-- <td>2</td> -->
        <!-- <td>3</td> -->
      ...
      <tr>
        ...
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g1), 'r2')/2; echo number_format(($buffer_5), 4);?></td>
        <td><?php $buffer_6 = 0; if($cad1 != 0){ $buffer_6 = $buffer_5/$cad1; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g1), 'r1')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($cad1 != 0){ $buffer_6 = $buffer_5/$cad1; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g1 + 1), 'r3')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($cad1 != 0){ $buffer_6 = $buffer_5/$cad1; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g1 + 1), 'r4')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($cad1 != 0){ $buffer_6 = $buffer_5/$cad1; }; echo number_format($buffer_6, 2);?></td>
        <!-- <td>1</td> -->
        <!-- <td>2</td> -->
        <!-- <td>3</td> -->
      ...
      <tr>
        ...
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g2), 'r2')/2; echo number_format(($buffer_5), 4);?></td>
        <td><?php $buffer_6 = 0; if($cad2 != 0){ $buffer_6 = $buffer_5/$cad2; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g2), 'r1')/2; echo number_format(($buffer_5), 4);?></td>
        <td><?php $buffer_6 = 0; if($cad2 != 0){ $buffer_6 = $buffer_5/$cad2; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g2 + 1), 'r3')/2; echo number_format(($buffer_5), 4);?></td>
        <td><?php $buffer_6 = 0; if($cad2 != 0){ $buffer_6 = $buffer_5/$cad2; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g2 + 1), 'r4')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($cad2 != 0){ $buffer_6 = $buffer_5/$cad2; }; echo number_format($buffer_6, 2);?></td>
        <!-- <td>1</td> -->
        <!-- <td>2</td> -->
        <!-- <td>3</td> -->
      ...
      <tr>
        ...
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g3), 'r2')/2; echo number_format(($buffer_5), 4);?></td>
        <td><?php $buffer_6 = 0; if($cad3 != 0){ $buffer_6 = $buffer_5/$cad3; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g3), 'r1')/2; echo number_format(($buffer_5), 4);?></td>
        <td><?php $buffer_6 = 0; if($cad3 != 0){ $buffer_6 = $buffer_5/$cad3; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g3 + 1), 'r3')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($cad3 != 0){ $buffer_6 = $buffer_5/$cad3; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g3 + 1), 'r4')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($cad3 != 0){ $buffer_6 = $buffer_5/$cad3; }; echo number_format($buffer_6, 2);?></td>
        <!-- <td>1</td> -->
        <!-- <td>2</td> -->
        <!-- <td>3</td> -->
      ...
      <tr>
        ...
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g4), 'r2')/2; echo number_format(($buffer_5), 4);?></td>
        <td><?php $buffer_6 = 0; if($cad4 != 0){ $buffer_6 = $buffer_5/$cad4; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g4), 'r1')/2; echo number_format(($buffer_5), 4);?></td>
        <td><?php $buffer_6 = 0; if($cad4 != 0){ $buffer_6 = $buffer_5/$cad4; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g4 + 1), 'r3')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($cad4 != 0){ $buffer_6 = $buffer_5/$cad4; }; echo number_format($buffer_6, 2);?></td>
        <td class="dn"><?php $buffer_5 = getnLCL($conn, ($total_g4 + 1), 'r4')/2; echo number_format($buffer_5, 4);?></td>
        <td><?php $buffer_6 = 0; if($cad4 != 0){ $buffer_6 = $buffer_5/$cad4; }; echo number_format($buffer_6, 2);?></td>
        <!-- <td>1</td> -->
        <!-- <td>2</td> -->
        <!-- <td>3</td> -->
      ...
      <tr>
        ...
        <td class="dn" style="font-weight: bold;"></td>
